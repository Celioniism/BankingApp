...
public class AccountInfoController {
	...
	public String editSecurityQuestion(@PathVariable(name = "accountNo") int accountNo, @RequestBody AccountInfo accountInfo) {
		AIS.editSecurityQuestion(accountNo, accountInfo);
		return "Security Question edited";
	}
	
	@PutMapping("/editSecurityAnswer/{accountNo}")
	public String editSecurityAnswer(@PathVariable(name = "accountNo") int accountNo, @RequestBody AccountInfo accountInfo) {
		AIS.editSecurityAnswer(accountNo, accountInfo);
		return "Security Answer updated";
	}
	
	@GetMapping("/validateCustomer/{userName}/{password}")
	public boolean validateCustomer(@PathVariable(name = "userName") String userName, @PathVariable(name = "password") String password) {
